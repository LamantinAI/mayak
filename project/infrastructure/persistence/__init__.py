...
# runtime opens a SQLAlchemy session or engine. validate_runtime_ownership.py refuses
# create_async_engine outside the composition root; a Session or a sync engine it does not look for,
# so keeping them out is this convention, not a gate. Reads and
