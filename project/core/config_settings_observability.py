...
class ObservabilitySettings(BaseSettings):
    ...
    # Deliberately not APP_DEBUG. Debug is about developer ergonomics — reload, verbose
    ...
    # Renamed from `deep_trace_enabled` / ENABLE_DEEP_TRACE — that name described a depth
