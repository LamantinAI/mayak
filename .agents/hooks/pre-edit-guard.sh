...
#
# Why a hook and not a rule in prose. "generated and must not be edited directly" is stated in
# CLAUDE.md's own comment and in the AGENTS.md bullet it imports, and nothing enforces it there. The gate refreshes
