...
class TestSyncAgentDocs:
    ...
    def test_build_documents_embeds_shared_rules(
        ...
        # An "Architecture Reference" section used to sit here, pointing at
    ...
    def test_the_quick_start_comes_from_the_shared_source(
        ...
        # The first Quick Start step named the shipped vertical, and
        ...
        # Once, not twice. "Start here" sits in _SECTIONS_RENDERED_SEPARATELY, and
    ...
    def test_section_lost_to_heading_punctuation_is_reported(
        ...
        # The renderer matches a plain `Title:` line only. A heading carrying bold,
...
class TestUnparsedHeadingIsRefused:
    ...
    def test_prose_between_working_notes_and_its_bullets_is_refused(
        ...
        # Pinned against the check itself, not only against the raise. The dropped
        ...
        # The wrapper must not exist. The old fallback wrote one that read as a
