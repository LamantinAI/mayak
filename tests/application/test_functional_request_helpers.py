...
# This test lives here, not in tests/functional/, on purpose. The functional suite needs
...
async def test_a_request_helper_reads_an_empty_204_body_as_text(helper_name: str) -> None:
    ...
    # `__wrapped__` is the undecorated coroutine underneath the fixture, so the
