...
# .claude/skills/* ships as symlinks into .agents/skills/ (`git ls-files -s
...
# --frozen ensures the lockfile is the source of truth on first checkout.
...
# A plain `cp` was what this did until 2026-08-20. It carried the sample's
